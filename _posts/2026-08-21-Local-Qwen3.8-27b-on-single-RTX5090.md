...
| Speculative decoding | `Off`                                          | Take a bit of speed loss by disabling MTP(Multi Token Processing). 5090 is no slouch to be honest |
...
| Other startup params | `--use-eager`                                  | `Optional` This disables nvidia CUDA graphs, which again reduces VRAM allocation at the cost of speed. |
